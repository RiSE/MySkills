																				...
																				foreach ($professionals[$k] as $user) :
														                            ...
														                            ?>
																		          		<tr>
																					            ...
																					            <td>
																			            	      	<button class="btn" type="button" onclick="javascript:vermensagem('<?php echo $job->id_job;?>','<?php echo $idRecruter?>','<?php echo $user[0]->id_user;?>');" data-toggle="modal" data-target="#myModal2">
